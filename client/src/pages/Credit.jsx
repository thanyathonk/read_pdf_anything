...
function Credit() {
  ...
  return (
    <div className="max-w-7xl h-sreen overflow-y-scroll mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <h2 className="text-3xl font-semibold text-center mb-10 xl:mt-30 text-grey-800">
        Credit Plans
      </h2>
